 ...
 */
@Component
public class Server8201AuthenticationFilter implements Filter {

    private Logger logger = LoggerFactory.getLogger(Server8201AuthenticationFilter.class);

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        logger.info("Server8201Filter初始化");
    }
    ...
    @Override
    public void destroy() {
        logger.info("Server8201Filter销毁");
    }
}
